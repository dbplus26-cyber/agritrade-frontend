  ...
  return (
    <dl className="mt-4 grid grid-cols-1 gap-x-6 gap-y-3 border-t border-adm-hairline pt-3.5 @min-[420px]/settle:grid-cols-3">
          ...
          {settlement.hasFee ? (
            <>
              ...
              settlement.agreedFeeGhs !== null ? (
                <span className="mt-0.5 block text-[10.5px] text-adm-faint">
      ...
      <div className="min-w-0">
        ...
        <dd className="mt-0.5 min-w-0 text-[12px] text-adm-ink [overflow-wrap:anywhere]">
  ...
  return (
    <div className="mt-4">
      ...
      <ul className="mt-3 flex flex-col gap-2">
        {settlement.milestones.map((m, i) => (
          <li
            className="flex items-baseline gap-3 text-[11.5px] leading-[1.4]"
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        {payment.paymentAccount ? (
          <p className="mt-0.5 min-w-0 text-[11px] text-adm-faint [overflow-wrap:anywhere]">
    ...
    <AdminCard className="@container/settle p-5">
      <SectionHeading
        ...
        actions={
          ...
          <p className="min-w-0 text-[11px] text-adm-muted [overflow-wrap:anywhere]">
            {driver.name}
          </p>
        }
      >
      ...
      {settlement.hasFee && !settlement.snapshotValid ? (
        <p className="mt-4 rounded-none bg-[#F8E9E7] px-3 py-2 text-[11px] text-[#8E2E24]">
            ...
            {adjustments.map((a) => {
              ...
              return (
                <li className="flex items-baseline gap-3 text-[11.5px]" key={a.id}>
                  ...
                  <span className="flex-none text-[10.5px] text-adm-faint">
